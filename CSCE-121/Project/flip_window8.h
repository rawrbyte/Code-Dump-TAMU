...
#ifndef flip_window8_GUARD
#define flip_window8_GUARD 1

#include "GUI.h"    // for flip_window8 only (doesn't really belong in Window.h)
#include "Graph.h"
...
struct flip_window8 : Graph_lib::Window {
	flip_window8(Point xy, int w, int h, const string& title );
...
private:
	...
	static void cb_p8(Address,Address);
