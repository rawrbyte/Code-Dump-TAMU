...
#ifndef flip_window7_GUARD
#define flip_window7_GUARD 1

#include "GUI.h"    // for flip_window7 only (doesn't really belong in Window.h)
#include "Graph.h"
...
struct flip_window7 : Graph_lib::Window {
	flip_window7(Point xy, int w, int h, const string& title );
...
private:
	...
	static void cb_p7(Address,Address);
